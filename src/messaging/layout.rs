...
impl DefaultLayout {
    ...
    pub fn resolve(area: Rect) -> Self {
        ...
        let msg_h = chat_area.height.saturating_sub(input_total_h).saturating_sub(margin);
        ...
        let [user_input_area, submit_btn_full] = Layout::horizontal([
        ...
        let [_tools_gap_top, tools_area, _tools_mcp_gap, mcp_area, _mcp_gap_bottom] = Layout::vertical([
