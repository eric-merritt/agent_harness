...
impl SafetensorsFile {
    pub fn default_alignment() -> usize { 8 }
...
impl ModelAdapter for SafetensorsFile {
    ...
    fn alignment(&self) -> usize { Self::default_alignment() }
...
impl SafetensorsHeader {
    ...
    pub fn parse_from_file(path: &std::path::Path) -> Result<(Self, usize), Box<dyn std::error::Error>> {
        use std::io::Read;
    ...
    pub fn parse_from_bytes(data: &[u8]) -> Result<(Self, usize), Box<dyn std::error::Error>> {
        ...
        if data.len() < 8 + header_len { return Err("header extends past file".into()); }
...
pub enum SafetensorsDtype {
    BOOL, U8, I8, I16, U16, I32, U32, F16, BF16, F32, F64, I64, U64,
}
...
impl SafetensorsDtype {
    ...
    pub fn bytes_per_element(&self) -> usize {
        match self {
            ...
            SafetensorsDtype::I16 | SafetensorsDtype::U16 | SafetensorsDtype::F16 | SafetensorsDtype::BF16 => 2,
    ...
    pub fn dequantize_to_f32(&self, raw: &[u8], n_elems: usize) -> Vec<f32> {
        match self {
            SafetensorsDtype::F32 => raw.chunks_exact(4)
...
impl From<SafetensorsDtype> for TensorDtype {
    fn from(d: SafetensorsDtype) -> Self {
        match d {
            ...
            SafetensorsDtype::F64 | SafetensorsDtype::U16 | SafetensorsDtype::U32 | SafetensorsDtype::U64 => TensorDtype::F32,
        }
    }
}